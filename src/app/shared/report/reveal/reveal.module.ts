...
@NgModule({
  ...
  declarations: [RevealComponent, RevealSectionDirective, RevealSectionDef, RevealSectionOutlet],
  exports: [RevealComponent, RevealSectionDirective, RevealSectionDef, RevealSectionOutlet],
})
