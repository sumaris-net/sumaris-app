...
export const MATERIAL_TESTING_PAGES: TestingPage[] = [{ label: 'Sampling ratio field', page: '/testing/shared/material/samplingRatio' }];
...
@NgModule({
  imports: [CommonModule, SharedModule, TranslateModule.forChild(), RouterModule.forChild(routes), MatSamplingRatioFieldModule],
  declarations: [AppSamplingRatioTestPage],
