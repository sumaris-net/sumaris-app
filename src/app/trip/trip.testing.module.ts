...
@NgModule({
  ...
  declarations: [BatchFormTestPage, BatchGroupFormTestPage, BatchTreeTestPage, BatchTreeContainerTestPage, PhysicalGearsTestPage, SampleTreeTestPage],
  exports: [BatchFormTestPage, BatchGroupFormTestPage, BatchTreeTestPage, BatchTreeContainerTestPage, SampleTreeTestPage, PhysicalGearsTestPage],
})
