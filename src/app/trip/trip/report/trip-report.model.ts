...
export class ApaseStation extends Station<ApaseStation>{
...
export class ApaseSpeciesList extends SpeciesList<ApaseSpeciesList>{
  gearIdentifier: number;
  subGearPosition: 'B'|'T';
...
export class ApaseSpeciesLength extends SpeciesLength<ApaseSpeciesLength>{
  subGearIdentifier: number;
  subGearPosition: 'B'|'T';
