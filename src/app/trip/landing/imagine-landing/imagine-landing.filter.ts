...
export class ImagineLandingFilter extends RootDataEntityFilter<ImagineLandingFilter, ImagineLanding> {
  static fromObject: (source: any, opts?: any) => ImagineLandingFilter;
  ...
  fromObject(source: any, opts?: any) {
    ...
    this.taxonNames = source.taxonNames;
  ...
  asObject(opts?: EntityAsObjectOptions): any {
    ...
    if (opts && opts.minify) {
      ...
      target.taxonNames = this.taxonNames;
  ...
  buildFilter(): FilterFn<ImagineLanding>[] {
