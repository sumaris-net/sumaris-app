  ...
  ngOnInit() {
    ...
    if (this.showTaxonName) {
      ...
      if (this.mobile) {
        ...
        this._state.connect('taxonNames', parentControl.valueChanges.pipe(
      ...
      // Desktop
        ...
        this._state.connect('taxonNames',
    ...
    this._state.connect('initialPmfms', this._state.select('qvPmfm')
      .pipe(
        filter(() => this.loaded),
