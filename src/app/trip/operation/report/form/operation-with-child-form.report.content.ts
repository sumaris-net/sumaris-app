...
interface OperationWithChildFormReportContentPageDimension extends ReportTableContentPageDimension {
...
export class OperationWithChildFromReportContentStats extends CommonReportContentStats {
  options: {
...
@Component({
  ...
  selector: 'operation-with-child-form-report-content',
  templateUrl: './operation-with-child-form.report.content.html',
  styleUrls: ['./operation-form.report.content.scss', '../../../../data/report/base-form-report.scss'],
})
export class OperationWithChildFormReportContent
  extends ReportTableContent<Operation[], OperationWithChildFromReportContentStats, OperationWithChildFormReportContentPageDimension>
  implements OnInit
{
  ...
  constructor(protected settings: LocalSettingsService) {
    super(Array<Operation>, OperationWithChildFromReportContentStats);
  }
  ...
  protected computePageDimensions(): OperationWithChildFormReportContentPageDimension {
    return {
  ...
  protected async computeStats(
    data: Operation[],
    _?: IComputeStatsOpts<OperationWithChildFromReportContentStats>
  ): Promise<OperationWithChildFromReportContentStats> {
    const stats = new OperationWithChildFromReportContentStats();
    ...
    stats.nbOperationByPage = OperationWithChildFormReportContent.NB_LINE_PEER_PAGE;
