...
export class ExpenseForm extends MeasurementsForm implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    this.registerSubscription(
      this.gearForms.changes.subscribe((value) => {
        console.debug('[expense] value: ', value);
  ...
  //   try {
  //     console.debug('[expense] this.baitForms: ', this.baitForms);
  ...
  //
  //     console.debug('[expense] baits: ', baits);
  //
  ...
  async setGearValue(data: Measurement[]) {
    try {
      console.debug('[expense] this.gearForms:', this.gearForms);
  ...
  //       if (this.enabled) baitForm.enable();
  //     });
  //   }
  //
  ...
  //     if (this.enabled) this.baitForms.last.enable();
  //   }
  //
  ...
  refreshGearForms() {
    ...
    if (this.applyingGearMeasurements) {
      ...
      this.gearForms.forEach((gearForm) => {
        ...
        if (this.enabled) gearForm.enable();
      });
    }
    ...
    if (this.addingNewGear) {
      ...
      if (this.enabled) this.gearForms.last.enable();
    }
