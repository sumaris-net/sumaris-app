...
@Component({
  ...
  styleUrls: [
    './activity-calendar-offline.modal.scss'
  ],
  templateUrl: './activity-calendar-offline.modal.html',
  animations: [slideUpDownAnimation],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ActivityCalendarOfflineModal extends AppForm<ActivityCalendarSynchroImportFilter> implements OnInit, ActivityCalendarOfflineModalOptions{
