  ...
  implements OnInit, AfterViewInit
{
  ...
  onResize() {
    this.resizeCellSelection(this.cellSelection);
    this.resizeCellSelection(this.cellClipboard);
  }

  protected resizeCellSelection(cellSelection: TableCellSelection) {
    if (!cellSelection) return;
    // DEBUG
    console.debug(`${this.logPrefix}Resizing cell selection...`);
  ...
  protected async copyCellSelectionToClipboard(cellSelection?: TableCellSelection): Promise<boolean> {
    ...
    this.cellClipboard = { cellElement: cellSelection.cellElement, divElement: rectElement, cellRect: cellSelection.cellRect, row, columnName };
    this.markForCheck();
  }
