...
import {Department, Entity, EntityAsObjectOptions, EntityClass, EntityFilter, fromDateISOString, Person, toDateISOString} from '@sumaris-net/ngx-components';
...
export class DevicePosition<T extends DevicePosition<any, ID>, ID = number, AO = EntityAsObjectOptions, FO = any> extends RootDataEntity<T, ID> {
  ...
  fromObject(source: any, opts?: FO) {
    ...
    // this.objectType = ObjectType.fromObject(source.objectType, opts);
