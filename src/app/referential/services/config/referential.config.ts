...
export const REFERENTIAL_CONFIG_OPTIONS = Object.freeze({
  ...
  PMFM_NET_STRING_LAYOUT_ID: <FormFieldDefinition>{
    key: 'sumaris.enumeration.Pmfm.NET_STRING_LAYOUT.id',
    label: 'CONFIGURATION.OPTIONS.ENUMERATION.PMFM_NET_STRING_LAYOUT_ID',
    type: 'entity',
    autocomplete: PmfmAutocompleteConfig,
    defaultValue: PmfmIds.NET_STRING_LAYOUT,
  },
  PMFM_DISTANCE_TO_NEAREST_NET_ID: <FormFieldDefinition>{
    key: 'sumaris.enumeration.Pmfm.DISTANCE_TO_NEAREST_NET.id',
    label: 'CONFIGURATION.OPTIONS.ENUMERATION.PMFM_DISTANCE_TO_NEAREST_NET_ID',
    type: 'entity',
    autocomplete: PmfmAutocompleteConfig,
    defaultValue: PmfmIds.DISTANCE_TO_NEAREST_NET,
  },
  PMFM_DISTANCE_BETWEEN_ZIGZAG_NETS_ID: <FormFieldDefinition>{
    key: 'sumaris.enumeration.Pmfm.DISTANCE_BETWEEN_ZIGZAG_NETS.id',
    label: 'CONFIGURATION.OPTIONS.ENUMERATION.PMFM_DISTANCE_BETWEEN_ZIGZAG_NETS_ID',
    type: 'entity',
    autocomplete: PmfmAutocompleteConfig,
    defaultValue: PmfmIds.DISTANCE_BETWEEN_ZIGZAG_NETS,
  },
  PMFM_OTHER_NET_STRING_LAYOUT_ID: <FormFieldDefinition>{
    key: 'sumaris.enumeration.Pmfm.OTHER_NET_STRING_LAYOUT.id',
    label: 'CONFIGURATION.OPTIONS.ENUMERATION.PMFM_OTHER_NET_STRING_LAYOUT_ID',
    type: 'entity',
    autocomplete: PmfmAutocompleteConfig,
    defaultValue: PmfmIds.OTHER_NET_STRING_LAYOUT,
  },
  PMFM_DECOMPOSITION_STATE_ID: <FormFieldDefinition>{
    key: 'sumaris.enumeration.Pmfm.DECOMPOSITION_STATE.id',
    label: 'CONFIGURATION.OPTIONS.ENUMERATION.PMFM_DECOMPOSITION_STATE_ID',
    type: 'entity',
    autocomplete: PmfmAutocompleteConfig,
    defaultValue: PmfmIds.DECOMPOSITION_STATE,
  },
  PMFM_IS_ENTANGLED_ID: <FormFieldDefinition>{
    key: 'sumaris.enumeration.Pmfm.IS_ENTANGLED.id',
    label: 'CONFIGURATION.OPTIONS.ENUMERATION.PMFM_IS_ENTANGLED_ID',
    type: 'entity',
    autocomplete: PmfmAutocompleteConfig,
    defaultValue: PmfmIds.IS_ENTANGLED,
  },
  PMFM_PINGER_ACCESSIBLE_ID: <FormFieldDefinition>{
    key: 'sumaris.enumeration.Pmfm.PINGER_ACCESSIBLE.id',
    label: 'CONFIGURATION.OPTIONS.ENUMERATION.PMFM_PINGER_ACCESSIBLE_ID',
    type: 'entity',
    autocomplete: PmfmAutocompleteConfig,
