...
export class FullReferential<
  T extends FullReferential<T, ID> = FullReferential<any, any>,
  ID = number,
...
> extends BaseReferential<T, ID, AO, FO> {
  ...
  fromObject(source: any, opts?: FO) {
    ...
    this.parent =
      (source.parent && ReferentialRef.fromObject(source.parent)) ||
      (isNotNil(source.parentId) && ReferentialRef.fromObject({ id: source.parentId }));
