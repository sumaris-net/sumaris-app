...
export const PmfmIds = {
  ...
  /* DOLPHINFREE (ID from open-test) */
  CAMERA_USED: 1036,
  NET_STRING_LAYOUT: 1038,
  DISTANCE_TO_NEAREST_NET: 1039,
  DISTANCE_BETWEEN_ZIGZAG_NETS: 1040,
  OTHER_NET_STRING_LAYOUT: 1041,
