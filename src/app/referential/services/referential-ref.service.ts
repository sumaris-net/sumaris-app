  ...
  implements SuggestService<ReferentialRef, ReferentialRefFilter>, IEntitiesService<ReferentialRef, ReferentialRefFilter>
{
  ...
  private updateModelEnumerations(config: Configuration) {
    ...
    */
    ...
    QualitativeValueIds.PRESERVATION.ALIVE = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.QUALITATIVE_VALUE_PRESERVATION_ALIVE_ID);
    ...
    QualitativeValueIds.BATCH_SORTING.NONE = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.QUALITATIVE_VALUE_SORTING_UNSORTED_ID);
