  ...
  implements SuggestService<ReferentialRef, ReferentialRefFilter>, IEntitiesService<ReferentialRef, ReferentialRefFilter>
{
  ...
  private updateModelEnumerations(config: Configuration) {
    ...
    */
    ...
    PmfmIds.CAMERA_USED = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_CAMERA_USED_ID);
    ...
    PmfmIds.DISCARD_OR_LANDING = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_DISCARD_OR_LANDING);
    ...
    PmfmIds.SIZE_UNLI_CAT = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_SIZE_UNLI_CAT_ID);
    ...
    PmfmIds.HAS_PETS = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_HAS_PETS_ID);
    PmfmIds.SALE_TYPE_ID = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_SALE_TYPE_ID);
    ...
    PmfmIds.TAXON_GROUP_ID = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_TAXON_GROUP_ID);
    PmfmIds.SIZE_UE_CAT = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_SIZE_UE_CAT_ID);
    PmfmIds.SURVEY_QUALIFICATION = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_SURVEY_QUALIFICATION_ID);
    PmfmIds.SURVEY_RELIABILITY = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_SURVEY_RELIABILITY_ID);
    PmfmIds.AUCTION_HABIT = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_AUCTION_HABIT_ID);
    PmfmIds.INACTIVITY_YEAR = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_INACTIVITY_YEAR_ID);
    PmfmIds.DURATION_AT_SEA_DAYS = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_DURATION_AT_SEA_DAYS_ID);
    PmfmIds.FISHING_DURATION_DAYS = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_FISHING_DURATION_DAYS_ID);
    PmfmIds.NET_STRING_LAYOUT = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_NET_STRING_LAYOUT_ID);
    PmfmIds.DISTANCE_TO_NEAREST_NET = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_DISTANCE_TO_NEAREST_NET_ID);
    PmfmIds.DISTANCE_BETWEEN_ZIGZAG_NETS = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_DISTANCE_BETWEEN_ZIGZAG_NETS_ID);
    PmfmIds.OTHER_NET_STRING_LAYOUT = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_OTHER_NET_STRING_LAYOUT_ID);
    PmfmIds.DECOMPOSITION_STATE = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_DECOMPOSITION_STATE_ID);
    PmfmIds.IS_ENTANGLED = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_IS_ENTANGLED_ID);
    PmfmIds.PINGER_ACCESSIBLE = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_PINGER_ACCESSIBLE_ID);
    PmfmIds.PINGER_CODE = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.PMFM_PINGER_CODE_ID);
    ...
    QualitativeValueIds.SPECIES_LIST_ORIGIN.PETS = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.QUALITATIVE_VALUE_SPECIES_LIST_ORIGIN_PETS_ID);
    QualitativeValueIds.SPECIES_LIST_ORIGIN.RANDOM = +config.getProperty(REFERENTIAL_CONFIG_OPTIONS.QUALITATIVE_VALUE_SPECIES_LIST_ORIGIN_RANDOM_ID);
    QualitativeValueIds.SURVEY_QUALIFICATION.DIRECT = +config.getProperty(
      REFERENTIAL_CONFIG_OPTIONS.QUALITATIVE_VALUE_SURVEY_QUALIFICATION_DIRECT_ID
    );
