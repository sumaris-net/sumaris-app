...
- Télécharger des photos, comme l'avatar du profil utilisateur ou des photos de spécimens de poissons ;
- Télécharger des vidéos (bientôt disponible) ;
...
- Les positions des navires sont stockées localement, puis utilisées et téléchargées vers le [SUMARiS Pod](https://github.com/sumaris-net/sumaris-pod/) si l'utilisateur décide de saisir la latitude/longitude dans l'écran d'opération de pêche.
  > Les positions des navires peuvent être ajoutées depuis les écrans suivants de l'application :
  > - Formulaire d'opération de pêche (`Menu > Voyages > sélectionner un voyage > sélectionner une opération`).
- **Seulement quand l'utilisateur est connecté aux **Seychelles Fisheries Authorities** (SFA Pod - https://sih.sfa.sc) :**
