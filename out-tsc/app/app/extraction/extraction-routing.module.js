...
let AppExtractionRoutingModule = class AppExtractionRoutingModule {
};
AppExtractionRoutingModule = __decorate([
    NgModule({
        imports: [
            SharedModule,
            AppExtractionModule,
...
export { AppExtractionRoutingModule };
//# sourceMappingURL=extraction-routing.module.js.map