...
export class PmfmValidators {
    ...
    static significantFiguresNumber(n) {
        return (control) => {
            const value = control.value;
            let significantFigures;
            let strValue = (typeof value === 'string') ? value : ((typeof value === 'number') ? String(value) : '');
            if (strValue) {
...
//# sourceMappingURL=pmfm.validators.js.map