...
AppModule = __decorate([
    NgModule({
        ...
        imports: [
            ...
            CacheModule.forRoot(Object.assign({ keyPrefix: '' }, environment.cache)),
            IonicStorageModule.forRoot(Object.assign({ name: 'sumaris' }, environment.storage)),
            ...
            AppSharedModule.forRoot({
                loader: {
                    ...
                    deps: [HttpClient],
                    useFactory: (httpClient) => new EnvironmentHttpLoader(httpClient, environment),
                },
            }),
        ...
        providers: [
            ...
            // Form errors translations
            {
                ...
                useValue: Object.assign(Object.assign(Object.assign(Object.assign({}, PMFM_VALIDATOR_I18N_ERROR_KEYS), OPERATION_VALIDATOR_I18N_ERROR_KEYS), BATCH_VALIDATOR_I18N_ERROR_KEYS), SAMPLE_VALIDATOR_I18N_ERROR_KEYS),
            },
            ...
            // Setting options definition
            {
                ...
                useValue: {
                    ...
                    options: Object.assign(Object.assign(Object.assign(Object.assign({}, SHARED_LOCAL_SETTINGS_OPTIONS), REFERENTIAL_LOCAL_SETTINGS_OPTIONS), VESSEL_LOCAL_SETTINGS_OPTIONS), TRIP_LOCAL_SETTINGS_OPTIONS),
                },
            },
            ...
            // Menu config
            {
                ...
                deps: [ENVIRONMENT],
                useFactory: (environment) => (Object.assign(Object.assign({ enableSubMenus: true, enableSubMenuIcon: true }, environment === null || environment === void 0 ? void 0 : environment.menu), environment === null || environment === void 0 ? void 0 : environment.menu)),
            },
            // Menu items
            {
            ...
            // Entities Apollo cache options
            {
                ...
                useValue: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, REFERENTIAL_GRAPHQL_TYPE_POLICIES), DATA_GRAPHQL_TYPE_POLICIES), VESSEL_GRAPHQL_TYPE_POLICIES), TRIP_GRAPHQL_TYPE_POLICIES), EXTRACTION_GRAPHQL_TYPE_POLICIES),
            },
            // Entities storage options
            {
                provide: APP_LOCAL_STORAGE_TYPE_POLICIES,
                useValue: Object.assign({}, TRIP_STORAGE_TYPE_POLICIES),
            },
            // Testing pages
            {
