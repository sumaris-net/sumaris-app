...
let BatchTreeTestPage = class BatchTreeTestPage {
    constructor(formBuilder, referentialRefService, programRefService, entities, tripService, context) {
    ...
    updateView(data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield waitFor(() => !!this.batchTree, { timeout: 2000 });
...
], BatchTreeTestPage.prototype, "mobileBatchTree", void 0);
__decorate([
    ViewChild('desktopBatchTree'),
    __metadata("design:type", BatchTreeComponent)
], BatchTreeTestPage.prototype, "desktopBatchTree", void 0);
__decorate([
    ViewChild('tabGroup'),
    __metadata("design:type", MatTabGroup)
], BatchTreeTestPage.prototype, "tabGroup", void 0);
BatchTreeTestPage = __decorate([
    Component({
...
export { BatchTreeTestPage };
//# sourceMappingURL=batch-tree.test.js.map