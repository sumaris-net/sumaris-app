...
let AppObservedLocationRoutingModule = class AppObservedLocationRoutingModule {
};
AppObservedLocationRoutingModule = __decorate([
    NgModule({
        imports: [
...
], AppObservedLocationRoutingModule);
export { AppObservedLocationRoutingModule };
//# sourceMappingURL=observed-location-routing.module.js.map