...
let AppObservedLocationModule = class AppObservedLocationModule {
    constructor() {
        console.debug('[observed-location] Creating module...');
    }
};
AppObservedLocationModule = __decorate([
    NgModule({
        imports: [
            AppCoreModule,
...
export { AppObservedLocationModule };
//# sourceMappingURL=observed-location.module.js.map