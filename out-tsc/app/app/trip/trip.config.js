...
export const TRIP_FEATURE_DEFAULT_PROGRAM_FILTER = Object.freeze({
...
export const TRIP_CONFIG_OPTIONS = Object.freeze({
    ...
    OBSERVED_LOCATION_LANDINGS_TAB_ENABLE: {
...
export const TRIP_GRAPHQL_TYPE_POLICIES = {
    MeasurementVO: {
 ...
 */
export const TRIP_STORAGE_TYPE_POLICIES = {
    TripVO: {
        mode: 'by-id',
...
//# sourceMappingURL=trip.config.js.map