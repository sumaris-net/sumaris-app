...
import { formatLatitude, formatLongitude } from '@sumaris-net/ngx-components';
...
export class MapGraticule extends L.GeoJSON {
    constructor(options) {
        super(undefined, Object.assign(Object.assign({}, defaultOptions), options));
        this.graticuleOptions = Object.assign(Object.assign({}, defaultOptions), options);
        this._formatOptions = { pattern: options === null || options === void 0 ? void 0 : options.latLngPattern, placeholderChar: '' };
