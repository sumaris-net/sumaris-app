...
export const VESSEL_GRAPHQL_TYPE_POLICIES = {
    VesselSnapshotVO: {
...
export const VESSEL_CONFIG_OPTIONS = {
    ...
    VESSEL_FILTER_DEFAULT_COUNTRY_ID: {
...
export const VESSEL_LOCAL_SETTINGS_OPTIONS = Object.freeze({
    ...
    FIELD_VESSEL_SNAPSHOT_ATTRIBUTES: {
...
//# sourceMappingURL=vessel.config.js.map